...
const navigationSections = reactive([
    ...
    },
    {
        items: [
            {
            name: 'Kanban ',
            route: 'shopify.kanban',
            icon: '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 5.25A2.25 2.25 0 016 3h3a2.25 2.25 0 012.25 2.25v13.5A2.25 2.25 0 019 21H6a2.25 2.25 0 01-2.25-2.25v-13.5zM12.75 5.25A2.25 2.25 0 0115 3h3a2.25 2.25 0 012.25 2.25v13.5A2.25 2.25 0 0118 21h-3a2.25 2.25 0 01-2.25-2.25v-13.5z" />',
            },
            { type: 'divider' }
        ]
    },
